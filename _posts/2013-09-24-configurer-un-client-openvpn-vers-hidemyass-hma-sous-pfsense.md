...
[![pfsense_hma_1]({{ site.url }}/assets/pfsense_hma_1.png)]({{ site.url }}/assets/pfsense_hma_1.png)

*   Une fois sauvegardé, le CA est visible sous le nom **HMA CA** comme ci-dessous:

[![pfsense_hma_2]({{ site.url }}/assets/pfsense_hma_2.png)]({{ site.url }}/assets/pfsense_hma_2.png)
...
[![pfsense_hma_3]({{ site.url }}/assets/pfsense_hma_3.png)]({{ site.url }}/assets/pfsense_hma_3.png)

*   Une fois sauvegardé, le certificat est visible sous le nom **HMA OVPN** comme ci-dessous:

[![pfsense_hma_4]({{ site.url }}/assets/pfsense_hma_4.png)]({{ site.url }}/assets/pfsense_hma_4.png)
...
[![pfsense_hma_5]({{ site.url }}/assets/pfsense_hma_5.png)]({{ site.url }}/assets/pfsense_hma_5.png)
...
[![pfsense_hma_6]({{ site.url }}/assets/pfsense_hma_6.png)]({{ site.url }}/assets/pfsense_hma_6.png)
...
[![pfsense_hma_7]({{ site.url }}/assets/pfsense_hma_7.png)]({{ site.url }}/assets/pfsense_hma_7.png)
...
[![pfsense_hma_8]({{ site.url }}/assets/pfsense_hma_82.png)]({{ site.url }}/assets/pfsense_hma_82.png)
...
[![pfsense_hma_9]({{ site.url }}/assets/pfsense_hma_9.png)]({{ site.url }}/assets/pfsense_hma_9.png)
...
[![pfsense_hma_10]({{ site.url }}/assets/pfsense_hma_10.png)]({{ site.url }}/assets/pfsense_hma_10.png)

*   Aller dans le menu **Status &gt; OpenVPN**.
*   Vérifier que le statut de la connexion VPN est bien "**up**".

[![pfsense_hma_11]({{ site.url }}/assets/pfsense_hma_11.png)]({{ site.url }}/assets/pfsense_hma_11.png)
...
[![pfsense_hma_12]({{ site.url }}/assets/pfsense_hma_12.png)]({{ site.url }}/assets/pfsense_hma_12.png)
...
[![pfsense_hma_13]({{ site.url }}/assets/pfsense_hma_13.png)]({{ site.url }}/assets/pfsense_hma_13.png)
...
[![pfsense_hma_14]({{ site.url }}/assets/pfsense_hma_14.png)]({{ site.url }}/assets/pfsense_hma_14.png)
...
[![pfsense_hma_15]({{ site.url }}/assets/pfsense_hma_15.png)]({{ site.url }}/assets/pfsense_hma_15.png)

*   Changer la passerelle (Gateway) et sélectionner **HMA_VPN_VPNV4** au lieu de WAN.

[![pfsense_hma_16]({{ site.url }}/assets/pfsense_hma_16.png)]({{ site.url }}/assets/pfsense_hma_16.png)
...
[![pfsense_hma_17]({{ site.url }}/assets/pfsense_hma_17.png)]({{ site.url }}/assets/pfsense_hma_17.png)
...
[![pfsense_hma_18]({{ site.url }}/assets/pfsense_hma_18.png)]({{ site.url }}/assets/pfsense_hma_18.png)
